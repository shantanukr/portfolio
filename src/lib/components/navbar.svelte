...
<div class="navbar mb-11 shadow-lg bg-neutral text-neutral-content sticky top-0 z-10 h-0.5">
  ...
  <div class="dropdown dropdown-left lg:hidden">
    ...
    <ul tabindex="0" class="bg-neutral rounded-box shadow text-neutral-content p-2 w-40 menu dropdown-content">
